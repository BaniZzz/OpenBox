...
const planCatalog = {
  ...
  plans: [
    {
      id: "free",
      prices_fen: { monthly: 0, yearly: 0 },
      credits: "10",
      credit_period: "weekly",
      recommended: false,
    },
    {
      id: "pro",
      prices_fen: { monthly: 59900, yearly: 718800 },
      credits: "280",
    ...
    {
      id: "max",
      prices_fen: { monthly: 210000, yearly: 2520000 },
      credits: "1680",
      credit_period: "monthly",
      recommended: false,
    },
...
export async function billingApi(page: Page, initialPlan = "pro", alipayTest = false) {
  ...
  if (alipayTest) {
    catalog.plans[1].prices_fen = { monthly: 10, yearly: 10 }
    catalog.plans[2].prices_fen = { monthly: 20, yearly: 20 }
  }
  let paid = false
